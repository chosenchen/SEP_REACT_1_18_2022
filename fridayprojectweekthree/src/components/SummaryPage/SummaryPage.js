...
import { ReactComponent as Responsivedesign } from '../../images/innovativesolutions.svg';
			...
			<div class = "container-fluid">
					...
					<div class = "development-summary">
						<div class = "col-sm-1 col-md-1">
							<div class = "development-img">
								<Developerdesign class = "img-responsive"/>
							</div>
						</div>
					...
					<div class = "responsive-summary">
						<div class = "col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
							<div class = "responsive-img">
								<Responsivedesign class = "img-responsive"/>
							</div>
						</div>
				...
				<div class = "row">
					<div class = "ideas-summary">
						<div class = "col-sm-1 col-md-1">
							<div class = "idea-img">
								<Innovativesolutions class = "img-responsive" />
							</div>
						</div>
